...
function newsimport() {
	...
	//test sheet
	$data = get_file_contents( "https://docs.google.com/spreadsheets/d/11pixm9kWxzXmGOkSWEMaK-WS3dmySw3gxGWwqNHVpAo/pubhtml?gid=0&single=true" );
	//real sheet
	...
	***************************************/
	...
	foreach( $array_multi as $arr ){
		...
		if ( !in_array( $n_id, $id_arr ) ) {
			...
			***************************************/
			$past_date = date( 'Y-m-d', strtotime( '2013/01/01' ) );
